...
const AddUser = (props) => {
  ...
  /* !!! WE MUST NOT USE REFS TO MANIPULATE THE DOM,
  WE USE IT ONLY TO READ SOME DATA */
  const nameInputRef = useRef(); // Here will be the real DOM-element, when React will reach the name input
